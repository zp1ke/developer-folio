...
[![GitHub](https://img.shields.io/github/license/zp1ke/developer-folio?color=blue)](https://github.com/zp1ke/developer-folio/blob/master/LICENSE)
...
You'll need [Node.js](https://nodejs.org/en/download/) (which comes with [npm](http://npmjs.com)) installed on your computer or use [Devcontainer](https://containers.dev/).
...
Set `showGithubProfile` to true or false to show Contact Profile using GitHub, defaults to true.
